<template>
    <el-form :model="formData" size="default" label-position="top" label-width="100" :rules="rules">
        ...
        <el-row gutter="24" justify="start" align="[object Object]" component="el-row" group="componentsGroup"
            class="drag-wrapper box" style="margin-left:0px;margin-right:0px" animation="340">
        ...
        <el-form-item :show-label="true" label-width="100" label="上传文件" prop="field_zrWSu">
            <upload-warp v-model="formData.field_zrWSu" upload-type="image"
                action="https://www.vkandian.cn/index.php/index/upload" name="file" :show-file-list="true"
                list-type="text" :auto-upload="true" limit="1">
            </upload-warp>
        </el-form-item>
    </el-form>
</template>
